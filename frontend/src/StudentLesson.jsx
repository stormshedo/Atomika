    ...
    return(
        <div>
            ...
            <div className="flex gap-24 px-10 items-start justify-between max-md:flex-col">
                <div className="w-[17.5%] max-md:w-full"><Link to="/student" className="w-fit flex items-center px-12 py-6 text-button bg-white rounded-full lh-[1px] text-[18px]"><ChevronLeftIcon className="w-5 h-5 text-gray-500" aria-hidden="true" />{t('back')}</Link></div>
